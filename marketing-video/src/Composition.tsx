...
const Shot = ({ clip, label, title, punch, caption, note, full = false, ending = false }: ShotProps) => {
  ...
  return <AbsoluteFill style={{ backgroundColor: "#f7f4e7", color: BLUE, fontFamily: "Microsoft YaHei, sans-serif", backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 55px, #283db412 56px, transparent 58px)" }}>
    <Audio src={staticFile(`voice-female/${clip}.wav`)} volume={1} />
...
const Promo = () => <AbsoluteFill>
  <Sequence durationInFrames={90} name="开头：笔记本枪战"><Shot clip="hook" label="这画风？" title="谁把枪战" punch="画进作业本了？" caption="随手画的涂鸦，居然能打枪？" note="真实游戏画面" /></Sequence>
  <Sequence from={90} durationInFrames={90} name="纸上世界"><Shot clip="world" label="01 / 画风" title="纸是地图" punch="笔下就是战场" caption="蓝色线条，画出一整个战场。" note="手绘 3D 场景" /></Sequence>
  <Sequence from={180} durationInFrames={120} name="单人实战"><Shot clip="auto" label="02 / 单人" title="一个人玩" punch="也得火力全开" caption="单人闯关，边走位，边开火。" note="单人闯关" /></Sequence>
  <Sequence from={300} durationInFrames={90} name="切换武器"><Shot clip="switch" label="切枪！" title="换把家伙" punch="接着打！" caption="换把武器，换种打法。" note="实战切枪" /></Sequence>
  <Sequence from={390} durationInFrames={90} name="失败反转"><Shot clip="fail" label="等一下…" title="以为自己很强" punch="那就再来一局" caption="没打过？再来一局！" note="翻车也是实况" full /></Sequence>
  <Sequence from={480} durationInFrames={60} name="联机房间"><Shot clip="room" label="03 / 联机" title="好友联机" punch="一起进房间" caption="还能叫朋友联机。" note="联机实录" full /></Sequence>
  <Sequence from={540} durationInFrames={120} name="联机开镜"><Shot clip="scope" label="瞄准中" title="开镜，瞄准" punch="和朋友较量" caption="进同一个房间，开镜瞄准，和朋友来场较量。" note="好友对狙" /></Sequence>
  <Sequence from={660} durationInFrames={90} name="换刀追击"><Shot clip="run" label="追上去！" title="切刀跑位" punch="拉近距离" caption="切刀跑位，拉近距离。" note="切刀移动" /></Sequence>
  <Sequence from={750} durationInFrames={90} name="再次对狙"><Shot clip="duel" label="再来一枪" title="画风很可爱" punch="瞄准得认真" caption="看着画风可爱，瞄准可得认真。" note="联机对战" /></Sequence>
  <Sequence from={840} durationInFrames={120} name="游戏推广收尾"><Shot clip="end" label="来一局？" title="涂鸦街区" punch="把涂鸦打成战场" caption="涂鸦街区。一个人闯，和朋友一起玩！" note="单人 / 联机" ending /></Sequence>
